...
{
  app_version     => '5.34.0.1', #BEWARE: do not use '.0.0' in the last two version digits
  bits            => 64,
  beta            => 0,
  ...
  build_job_steps => [
    ### NEXT STEP ###########################
    {
        ...
        install_packages => {
            ...
            #libs
            'bzip2'         => '<package_url>/kmx/64_libs/gcc83-2019Q2/64bit_bzip2-1.0.6-bin_20190522.zip',
            'db'            => '<package_url>/kmx/64_libs/gcc83-2019Q2/64bit_db-6.2.38-bin_20190522.zip',
            'expat'         => '<package_url>/kmx/64_libs/gcc83-2019Q2/64bit_expat-2.2.6-bin_20190522.zip',
            'fontconfig'    => '<package_url>/kmx/64_libs/gcc83-2019Q2/64bit_fontconfig-2.13.1-bin_20190522.zip',
            'freeglut'      => '<package_url>/kmx/64_libs/gcc83-2020Q1/64bit_freeglut-2.8.1-bin_20200209.zip',
            'freetype'      => '<package_url>/kmx/64_libs/gcc83-2019Q2/64bit_freetype-2.10.0-bin_20190522.zip',
            'fribidi'       => '<package_url>/kmx/64_libs/gcc83-2020Q3/64bit_fribidi-1.0.10-bin_20200712.zip',
            'gdbm'          => '<package_url>/kmx/64_libs/gcc83-2019Q2/64bit_gdbm-1.18-bin_20190522.zip',
            'giflib'        => '<package_url>/kmx/64_libs/gcc83-2019Q2/64bit_giflib-5.1.9-bin_20190522.zip',
            'gmp'           => '<package_url>/kmx/64_libs/gcc83-2019Q2/64bit_gmp-6.1.2-bin_20190522.zip',
            'graphite2'     => '<package_url>/kmx/64_libs/gcc83-2019Q2/64bit_graphite2-1.3.13-bin_20190522.zip',
            'harfbuzz'      => '<package_url>/kmx/64_libs/gcc83-2019Q2/64bit_harfbuzz-2.3.1-bin_20190522.zip',
            'jpeg'          => '<package_url>/kmx/64_libs/gcc83-2019Q2/64bit_jpeg-9c-bin_20190522.zip',
            'libffi'        => '<package_url>/kmx/64_libs/gcc83-2020Q1/64bit_libffi-3.3-bin_20200207.zip',
            'libgd'         => '<package_url>/kmx/64_libs/gcc83-2019Q2/64bit_libgd-2.2.5-bin_20190522.zip',
            'liblibiconv'   => '<package_url>/kmx/64_libs/gcc83-2019Q2/64bit_libiconv-1.16-bin_20190522.zip',
            'libidn2'       => '<package_url>/kmx/64_libs/gcc83-2019Q2/64bit_libidn2-2.1.1-bin_20190522.zip',
            'liblibpng'     => '<package_url>/kmx/64_libs/gcc83-2019Q2/64bit_libpng-1.6.37-bin_20190522.zip',
            'liblibssh2'    => '<package_url>/kmx/64_libs/gcc83-2019Q2/64bit_libssh2-1.8.2-bin_20190522.zip',
            'libunistring'  => '<package_url>/kmx/64_libs/gcc83-2019Q2/64bit_libunistring-0.9.10-bin_20190522.zip',
            'liblibxml2'    => '<package_url>/kmx/64_libs/gcc83-2019Q2/64bit_libxml2-2.9.9-bin_20190522.zip',
            'liblibXpm'     => '<package_url>/kmx/64_libs/gcc83-2019Q2/64bit_libXpm-3.5.12-bin_20190522.zip',
            'liblibxslt'    => '<package_url>/kmx/64_libs/gcc83-2019Q2/64bit_libxslt-1.1.33-bin_20190522.zip',
            'libwebp'       => '<package_url>/kmx/64_libs/gcc83-2020Q3/64bit_libwebp-1.1.0-bin_20200712.zip',
            'mpc'           => '<package_url>/kmx/64_libs/gcc83-2019Q2/64bit_mpc-1.1.0-bin_20190522.zip',
            'mpfr'          => '<package_url>/kmx/64_libs/gcc83-2019Q2/64bit_mpfr-4.0.2-bin_20190522.zip',
            'openssl'       => '<package_url>/kmx/64_libs/gcc83-2021Q1/64bit_openssl-1.1.1i-bin_20210124.zip',
            'postgresql'    => '<package_url>/kmx/64_libs/gcc83-2019Q2/64bit_postgresql-11.3-bin_20190522.zip',
            'readline'      => '<package_url>/kmx/64_libs/gcc83-2019Q2/64bit_readline-8.0-bin_20190522.zip',
            't1lib'         => '<package_url>/kmx/64_libs/gcc83-2019Q2/64bit_t1lib-5.1.2-bin_20190522.zip',
            'termcap'       => '<package_url>/kmx/64_libs/gcc83-2019Q2/64bit_termcap-1.3.1-bin_20190522.zip',
            'tiff'          => '<package_url>/kmx/64_libs/gcc83-2019Q2/64bit_tiff-4.0.10-bin_20190522.zip',
    ...
    ### NEXT STEP ###########################
    {
        ...
        url        => 'https://cpan.metacpan.org/authors/id/X/XS/XSAWYERX/perl-5.34.0.tar.gz',
        ...
        patch => { #DST paths are relative to the perl src root
            ...
            '<dist_sharedir>/perl-5.34/win32_config.gc.tt'      => 'win32/config.gc',
            '<dist_sharedir>/perl-5.34/perlexe.rc.tt'           => 'win32/perlexe.rc',
            '<dist_sharedir>/perl-5.34/win32_config_H.gc'       => 'win32/config_H.gc', # enables gdbm/ndbm/odbm
            '<dist_sharedir>/perl-5.34/win32_FindExt.pm'        => 'win32/FindExt.pm',
        },
    ...
    ### NEXT STEP ###########################
    {
        ...
        modules => [
            ...
            # CPANPLUS doesn't work at all
            { module=>'CPANPLUS', skiptest => 1 },
            ...
            qw/ IO-Compress-Lzma Archive::Extract /,
            { module=>'Compress::unLZMA', ignore_testfailure=>1 },
            ...
            qw/ File-Find-Rule File-HomeDir File-Listing File-Remove File-ShareDir File-Which /,
            { module => 'File::Map', ignore_testfailure => 1 },
            ...
            qw/ IO::Stringy Text-Diff Text-Patch Text::CSV Text::CSV_XS Tie::Array::CSV Excel::Writer::XLSX /,
            { module => 'Spreadsheet::ParseXLSX', ignore_testfailure => 1 },
            qw/ Spreadsheet::WriteExcel Spreadsheet::ParseExcel /,

            # database stuff
            qw/ DBI DBD-SQLite DBD-CSV DBD-ADO /,
            {module => 'DBIx-Class', ignore_testfailure => 1 },
            qw/ DBIx-Simple /,
            { module => 'DBD::ODBC', env=>{ DBD_ODBC_UNICODE=>1 } },
            'https://cpan.metacpan.org/authors/id/T/TU/TURNSTEP/DBD-Pg-3.8.0.tar.gz', ###{ module=>'DBD::Pg' },
            { module=>'DBD::mysql' },
            { module=>'DBD::Oracle', makefilepl_param=>'-V 19.11.0.0.0', env=>{ ORACLE_HOME=>'C:\ora1911instant64' }, skiptest=>1 }, ## requires Oracle Instant Client 64bit!!!
            ...
            # crypto
            { module =>'CryptX', ignore_testfailure=>1 }, 
            qw/ Crypt::OpenSSL::Bignum Crypt::OpenSSL::DSA Crypt-OpenSSL-RSA Crypt-OpenSSL-Random Crypt-OpenSSL-X509 /,
            ...
            #Crypt-SMIME ?
            { module =>'Crypt::CBC', ignore_testfailure=>1 }, 
            ...
            { module => 'Alt::Crypt::RSA::BigInt', ignore_testfailure => 1},  # hack Crypt-RSA without Math::PARI - https://metacpan.org/release/Crypt-RSA
            { module =>'Crypt::DSA', ignore_testfailure=>1 }, 
            qw/ Crypt::DSA::GMP /,
            ...
            { module => 'Email::Abstract', ignore_testfailure => 1 },
            qw/ Email::MIME::Kit Email::Sender Email::Simple Email::Valid /,
            { module => 'Email::Stuffer', ignore_testfailure => 1 },
            qw/ Mail::Send Net::SMTPS Net::SMTP Net::IMAP::Client Net::POP3 /,
    ...
    ### NEXT STEP ###########################
    {
        ...
        plugin  => 'Perl::Dist::Strawberry::Step::BinaryToolsAndLibs',
        install_packages => {
            'cfitsio'       => '<package_url>/kmx/64_libs/gcc83-2020Q3/64bit_cfitsio-3.48-bin_20200712.zip',
            ...
            'gsl'           => '<package_url>/kmx/64_libs/gcc83-2020Q1/64bit_gsl-2.6-bin_20200207.zip',
            'hdf4'          => '<package_url>/kmx/64_libs/gcc83-2019Q2/64bit_hdf-4.2.14-bin_20190522.zip',
            'hdf5'          => '<package_url>/kmx/64_libs/gcc83-2019Q2/64bit_hdf5-1.10.5-bin_20190522.zip',
            'plplot'        => '<package_url>/kmx/64_libs/gcc83-2019Q2/64bit_plplot-5.14.0-bin_20190522.zip',
            'proj'          => '<package_url>/kmx/64_libs/gcc83-2019Q2/64bit_proj-5.2.0-bin_20190522.zip',
            'szip'          => '<package_url>/kmx/64_libs/gcc83-2019Q2/64bit_szip-2.1.1-bin_20190522.zip',
            'talib'         => '<package_url>/kmx/64_libs/gcc83-2019Q2/64bit_ta-lib-0.4.0-bin_20190522.zip',
            'netcdf'        => '<package_url>/kmx/64_libs/gcc83-2019Q2/64bit_netcdf-c-4.6.3-bin_20190522.zip',
            'lapack'        => '<package_url>/kmx/64_libs/gcc83-2019Q2/64bit_lapack-3.8.0-bin_20190522.zip',
        },
    },
    ### NEXT STEP ###########################
    {
